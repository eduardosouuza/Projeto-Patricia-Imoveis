...
import { ArrowLeft, MapPin, Bed, Bath, Square, Calendar, Home, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8">
          ...
          <div className="mt-4 md:mt-0">
            <div className="text-3xl font-serif text-gold">{formatPrice(property.price)}</div>
          </div>
        </div>
      </div>
            ...
            {property.location && (
              <div>
                ...
                <div className="bg-neutral-100 h-80 flex items-center justify-center">
                  ...
                  <p className="ml-2 text-neutral-500">Mapa em breve</p>
                </div>
              </div>
            )}
          </div>
